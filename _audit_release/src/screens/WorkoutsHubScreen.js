...
export function WorkoutsHubView({ navigation, summary, todayWorkout, recommended }) {
  ...
  return (
    <ScrollView testID="screen-treinos" contentContainerStyle={styles.container}>
      ...
      <SecondaryButton testID="btn-open-social" title="Friends e desafios" onPress={() => navigation.navigate('SocialChallenges')} />
      <SecondaryButton testID="btn-open-ranking" title="Ranking e evolucao" onPress={() => navigation.navigate('RankingEvolution')} />
