export const nutritionDatabase = [
  ...
  { id: 'tapioca', nome: 'Tapioca', aliases: ['tapioca', 'goma tapioca'], porcao: '100g', kcal: 160, carbo: 39, prot: 0.2, gord: 0 },
  { id: 'cuscuz_milho', nome: 'Cuscuz de Milho', aliases: ['cuscuz', 'cuscuz milho'], porcao: '100g', kcal: 113, carbo: 25, prot: 2.3, gord: 0.7 },
  { id: 'banana_prata', nome: 'Banana Prata', aliases: ['banana', 'banana prata'], porcao: '80g (1 unid)', kcal: 70, carbo: 18, prot: 0.9, gord: 0.3 },
  { id: 'morango', nome: 'Morango', aliases: ['morango', 'morangos'], porcao: '100g', kcal: 30, carbo: 7, prot: 0.7, gord: 0.3 },
  ...
  { id: 'iogurte_proteico', nome: 'Iogurte Proteico', aliases: ['iogurte proteico', 'yopro', 'yopro chocolate'], porcao: '160g', kcal: 146, carbo: 12, prot: 15, gord: 2 },
  ...
  { id: 'granola', nome: 'Granola', aliases: ['granola'], porcao: '30g', kcal: 130, carbo: 21, prot: 3, gord: 4 },
  ...
  { id: 'tilapia_grelhada', nome: 'Tilapia Grelhada', aliases: ['tilapia', 'file tilapia'], porcao: '100g', kcal: 129, carbo: 0, prot: 26, gord: 2.7 },
  { id: 'salmao_grelhado', nome: 'Salmao Grelhado', aliases: ['salmao', 'file salmao'], porcao: '100g', kcal: 208, carbo: 0, prot: 20, gord: 13 },
  ...
  { id: 'mandioca_cozida', nome: 'Mandioca Cozida', aliases: ['mandioca', 'aipim', 'macaxeira'], porcao: '100g', kcal: 125, carbo: 30, prot: 1, gord: 0.3 },
  { id: 'queijo_mussarela', nome: 'Queijo Mussarela', aliases: ['queijo', 'mussarela', 'muzzarela'], porcao: '30g', kcal: 86, carbo: 1, prot: 6, gord: 6 },
  { id: 'queijo_minas', nome: 'Queijo Minas', aliases: ['queijo minas', 'minas frescal'], porcao: '30g', kcal: 80, carbo: 1, prot: 5.7, gord: 6.1 },
